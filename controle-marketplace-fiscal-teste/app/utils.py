...
def status_label(status):
    labels = {
        ...
        "NFE_FICTICIA_AUTORIZADA": "NF-e ficticia autorizada",
        "NFE_FICTICIA_REJEITADA": "NF-e ficticia rejeitada",
        "XML_FAKE_GERADO": "XML fake gerado",
        "PDF_FAKE_GERADO": "PDF fake gerado",
        "OK": "OK",
        "ERRO": "Erro",
    }
    if not status:
